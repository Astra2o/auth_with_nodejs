    ...
    <div className='flex justify-center my-[20%] items-center'>
        ...
        <div className='flex  flex-col gap-2'>
            ...
            <label htmlFor="email"></label>
             <input value={form.name} name='name' onChange={handleChange} placeholder='name' type="text" />
            </div>
            <div className='border'>
            <label htmlFor="email"></label>
             <input value={form.email} name='email' onChange={handleChange} placeholder='email' type="email" />
            </div>
            <div className='border'>
        ...
        <button className='bg-green-600 border border-1 p-1 px-3 rounded-full' onClick={registerSubmit}>register</button>
        </div>
